...
#elif defined(JS_VERSION)
JSBool js_PluginTuneJS_PluginTune_checkForDeferredDeepLink(JSContext *cx, uint32_t argc, jsval *vp)
{
    if (argc == 0) {
        sdkbox::PluginTune::checkForDeferredDeepLink();
        JS_SET_RVAL(cx, vp, JSVAL_VOID);
...
#elif defined(JS_VERSION)
JSBool js_PluginTuneJS_PluginTune_tuneId(JSContext *cx, uint32_t argc, jsval *vp)
{
    if (argc == 0) {
        std::string ret = sdkbox::PluginTune::tuneId();
        jsval jsret;
...
bool js_PluginTuneJS_PluginTune_setDeepLink(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    if (argc == 1) {
        std::string arg0;
        ok &= jsval_to_std_string(cx, args.get(0), &arg0);
        JSB_PRECONDITION2(ok, cx, false, "js_PluginTuneJS_PluginTune_setDeepLink : Error processing arguments");
...
#elif defined(JS_VERSION)
JSBool js_PluginTuneJS_PluginTune_setDeepLink(JSContext *cx, uint32_t argc, jsval *vp)
{
    jsval *argv = JS_ARGV(cx, vp);
    JSBool ok = JS_TRUE;
    if (argc == 1) {
...
void js_register_PluginTuneJS_PluginTune(JSContext *cx, JS::HandleObject global) {
    ...
    static JSFunctionSpec st_funcs[] = {
        ...
        JS_FN("checkForDeferredDeepLink", js_PluginTuneJS_PluginTune_checkForDeferredDeepLink, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        ...
        JS_FN("tuneId", js_PluginTuneJS_PluginTune_tuneId, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("setDeepLink", js_PluginTuneJS_PluginTune_setDeepLink, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
