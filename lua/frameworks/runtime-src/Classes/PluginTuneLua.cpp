...
int lua_PluginTuneLua_PluginTune_checkForDeferredDeepLink(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_PluginTuneLua_PluginTune_checkForDeferredDeepLink'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "sdkbox.PluginTune:checkForDeferredDeepLink",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_PluginTuneLua_PluginTune_checkForDeferredDeepLink'.",&tolua_err);
#endif
    return 0;
}
...
int lua_PluginTuneLua_PluginTune_tuneId(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_PluginTuneLua_PluginTune_tuneId'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "sdkbox.PluginTune:tuneId",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_PluginTuneLua_PluginTune_tuneId'.",&tolua_err);
#endif
    return 0;
}
int lua_PluginTuneLua_PluginTune_setDeepLink(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    {
        std::string arg0;
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "sdkbox.PluginTune:setDeepLink");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_PluginTuneLua_PluginTune_setDeepLink'", nullptr);
            return 0;
        }
        sdkbox::PluginTune::setDeepLink(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "sdkbox.PluginTune:setDeepLink",argc, 1);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_PluginTuneLua_PluginTune_setDeepLink'.",&tolua_err);
#endif
    return 0;
}
...
int lua_register_PluginTuneLua_PluginTune(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"PluginTune");
        ...
        tolua_function(tolua_S,"checkForDeferredDeepLink", lua_PluginTuneLua_PluginTune_checkForDeferredDeepLink);
        ...
        tolua_function(tolua_S,"tuneId", lua_PluginTuneLua_PluginTune_tuneId);
        tolua_function(tolua_S,"setDeepLink", lua_PluginTuneLua_PluginTune_setDeepLink);
